...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ./playground/data/llava_v1_5_mix665k/llava_v1_5_mix665k---textvqa-5k--vlguard.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/$SLURM_JOB_ID-llava-v1.5-7b-task-lora--textvqa-5k--vlguard \
    --num_train_epochs 1 \
